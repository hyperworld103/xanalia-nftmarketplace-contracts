...
/** 
   ...
   if(msg.sender == 0xaC940124F5f3B56B0c298Cca8e9E098C2cccAe2e){
    ...
    function emitBuyBoxNonGen(uint256 seriesId, uint256 currencyType, uint256 price, address collection, string memory ownerId) private{
        require(_boxesCrytpoUser[msg.sender][seriesId] < _perBoxUserLimit[seriesId] || (msg.sender == 0xaC940124F5f3B56B0c298Cca8e9E098C2cccAe2e && _boxesNoncryptoUser[ownerId][seriesId] < _perBoxUserLimit[seriesId]), "Limit reach" );
